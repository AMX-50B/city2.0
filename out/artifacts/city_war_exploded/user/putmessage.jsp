...
<head>
    ...
    <style>
        ...
        #mut select{height: 100%;width: 35%;font: italic 20px "Trebuchet MS", Verdana, Arial, Helvetica, sans-serif;}
    </style>
</head>
...
<div id="containe">
    ...
    <div id="bodier" style="height:600px;background: transparent;">
       <div id="pu" style="width: 100%;height: 100%;background: #9aafe5;-moz-border-radius: 5px;-webkit-border-radius: 5px;">
           <form action="${pageContext.request.contextPath}/user?m=Publish" method="post" enctype="multipart/form-data">
           <table id="mut" style="margin-left: 80px" align="center">
               <caption style="color: #2e6ab1;margin-bottom: 40px;margin-top: 40px; ">信息发布</caption>

               <tr>
                   <th>主题：</th>
                   <td><input type="text" name="title" value="请输入标题"></td>
                   <td class="uts" name="us">请输入1-6个字符</td>
               </tr>

               <tr>
                   <th>简介：</th>
                   <td><input type="text" name="description" value="请输入简介信息"></td>
                   <td class="uts" name="ps">请输入6-10个字母或数字的组合</td>
               </tr>
               <tr>
                   <th>类别：</th>
                   <td >父类：<select id="s1"  onchange="getsel()">
               ...
               <tr>
                   <th align="top">类容:</th>
                   <td ><textarea rows="10" cols="80" name="context"></textarea></td>
               ...
               <tr>
                   <th>联系人:</th>
                   <td><input type="text" name="contacts" value="jerry"></td>
                   <td class="uts" name="es">请输入联系人</td>
               </tr>
               <tr>
                   <th>电话:</th>
                   <td><input type="text" name="phone" value="110"></td>
